...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, drop_rate=0.2,
                 ...
                 downsample_padding=1, num_classes=1000, global_pool='avg', **kwargs):
        """
        Parameters
        ----------
...
@register_model
def seresnet10(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    default_cfg = default_cfgs['seresnet10']
    model = SENet(SEResNetBlock, [1, 1, 1, 1], groups=1, reduction=16,
