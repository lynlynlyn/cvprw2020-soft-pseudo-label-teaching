...
from .layers import SelectAdaptivePool2d, DropBlock2d, DropPath, AvgPool2dSame, create_attn, Mish
...
@register_model
def resnet10(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    """Constructs a ResNet-10 model.
    """
    default_cfg = default_cfgs['resnet10']
    model = ResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, in_chans=in_chans, **kwargs)
...
@register_model
def resnet10_mish(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    """Constructs a ResNet-10 model.
    """
    default_cfg = default_cfgs['resnet10']
    model = ResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes, in_chans=in_chans, act_layer=Mish, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
@register_model
def resnet14(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    """Constructs a ResNet-14 model.
    """
    default_cfg = default_cfgs['resnet14']
    model = ResNet(BasicBlock, [1, 2, 2, 1], num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
