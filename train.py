...
if __name__=='__main__':
    ...
    if params.method in ['baseline']:
        ...
        if params.dataset == "miniImageNet":
            ...
            datamgr = miniImageNet_few_shot.SimpleDataManager(image_size, batch_size=16, imagejitter=params.imagejitter)
            base_loader = datamgr.get_data_loader(aug=params.train_aug, grayscale=params.grayscale)
